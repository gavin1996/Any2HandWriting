...
class ExpConfig:
    ...
    # input and output
    DATA_BASE_DIR = 'result'
    DATA_PATH = 'result\\groundTruth.txt' # path containing data file names and labels. Format: 
    MODEL_DIR = 'train1200000' # the directory for saving and loading model parameters (structure is not stored)
    LOG_PATH = 'log.txt'
    ...
    TARGET_VOCAB_SIZE = 26+26+10+3 # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z, A-Z
